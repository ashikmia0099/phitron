...
//       buttons.classList.add("dis_button");

//       buttons.innerHTML = `
//           <button class="all_buttons" id="${Btn_category.category_id}" onclick="showCards('${Btn_category.category_id}')">
//               ${Btn_category.category}
//           </button>
//       `;
//       button_division.appendChild(buttons);
//   });
// };
